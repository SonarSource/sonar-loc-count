...
#  @package     :                                                                                  #
#  @subpackage  : gitlab_onpremise.ps1                                                             #
#  @access      :                                                                                  #
#  @paramtype   : baseURL,connectionToken,groupName or path_with_namespace                         #
#  @argument    :                                                                                  #
#  @description : Get Number ligne of Code in GitLab On-Premise                                    #
#  @usage : ./gitlab_onpremise.ps1 <baseURL> <token> <groupName> <PATH for cloc binary>           #                                                              
#                                                                                                  #
#                                                                                                  #
#                                                                         #
#  @version 1.01                                                                                   #
...
# Set Variables CLOCBr (object: [NBR_LINE_CODE][BRANCHE_NAME]), cpt, NBCLOC
#--------------------------------------------------------------------------------------#
...
if ($args.Length -lt 4) {
  ...
  Write-Output ('Example: gitlab_onpremise.ps1 https://gitlab.example.com mytoken mygroup C:\tools\cloc.exe')
    ...
    # Set Variables baseURL, token, groupName and PATH for cloc binary
    #--------------------------------------------------------------------------------------#
    $baseURL=$args[0]
